<template>
  <section>
    ...
    <el-table :data="orderList" border highlight-current-row v-loading="loading">
	    ...
	    <el-table-column prop="statusFreeze" label="订单状态" width="120" :formatter="formatStatus"></el-table-column>
        ...
        <el-table-column label="操作" width="160">
	        <template scope="scope">
				<el-button v-if="scope.row.statusFreeze===2" size="small" @click="">系统解冻</el-button>
				<el-button v-if="scope.row.statusFreeze===1" size="small" @click="">系统冻结</el-button>
  ...
  export default {
    ...
    methods: {
	    ...
	    handleCheck (index,row) {
			this.$router.push({
				path:'/admin/order/systrmFreezeOrderDetail',
