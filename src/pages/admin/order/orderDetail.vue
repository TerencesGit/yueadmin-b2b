		...
		created(){
			...
			console.log(res)			
			 ...
			 if(res.data.code === "0001"){
				...
				this.orderInfo.orderCode = data.info.orderCode ? data.info.orderCode : "";
			 	this.orderInfo.status = data.info.status ? data.info.status : "";
				this.orderInfo.remarks = data.item.remarks ? data.item.remarks : "";
				this.orderInfo.premarks = data.info.premarks ? data.info.premarks : "";
